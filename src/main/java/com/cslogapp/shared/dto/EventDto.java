package com.cslogapp.shared.dto;

import java.util.Objects;

import com.cslogapp.shared.dto.EventDto;
import com.cslogapp.shared.dto.EventDto.State;
...
public class EventDto {
    ...
    @JsonCreator
    public EventDto(@JsonProperty(value = "id", required = true) String id, @JsonProperty(value = "state", required = true) State state, @JsonProperty("type") String type,
